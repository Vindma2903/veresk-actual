...
@section('content')
    <div class="flex flex-col gap-24 lg:gap-32">
        <img src="https://placehold.co/1248x580" alt="">
        ...
        @include('_parts/three_images_inline', ['images' => ['https://placehold.it/450x600', 'https://placehold.it/450x600', 'https://placehold.it/450x600']])
        ...
        <div>
            <img src="https://placehold.co/624x580" alt="">
        </div>

        <div class="flex gap-3">
            <div class="basis-1/3"></div>
            <div class="basis-1/3">
                <img src="https://placehold.it/450x600" alt="">
            </div>
            <div class="basis-1/3">
                <img src="https://placehold.it/450x600" alt="">
            </div>
        ...
        <div class="flex gap-3">
            <div class="basis-1/3">
                <img src="https://placehold.it/412x390" alt="">
            </div>
            <div class="basis-2/3">
                <img src="https://placehold.it/824x500" alt="">
            </div>
        </div>
